'''
Basic ingredients for the first numerical example
of the Continuous No-Regret work with Walid
...
from .LossFunctions import QuadraticLossFunction
from .Domains import Rectangle, UnionOfDisjointRectangles
from .utils import compute_etaopt, parse_regrets, nustar_quadratic, nustar_generic
...
#                        etaopts=None, etas=None, alphas=None, 
#                        thetas=None, **kwargs):
...
#     def compute_optimum(self, Ngrid=10000):
#         """ Computes the optimal decision in hindsight and the associated
#             overall loss. For now do a very stupid gridding approach. """
#         gridpoints = self.domain.bbox().grid(Ngrid)
#         losses = self.loss(gridpoints)[self.domain.iselement(gridpoints)]
#         optval = np.min(losses)
#         return optval
...
#                  etaopts=None, regs_etaopts=None,
#                  etas=None, regs_etas=None, alphas=None, thetas=None, 
#                  regs_alphas=None, algo='hedge', desc='???'):
